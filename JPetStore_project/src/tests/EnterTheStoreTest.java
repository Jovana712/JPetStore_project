...
public class EnterTheStoreTest {
	...
	@Test
	public void enterTheStoreTest() throws InterruptedException {

		driver.navigate().to(this.locators.getProperty("petEnterUrl"));

		HomePage hp = new HomePage(driver, locators, waiter);
		hp.enterTheStore();

		Assert.assertTrue(hp.isEnteredTheStore());
